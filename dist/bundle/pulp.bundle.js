...
/***/ function(module, exports, __webpack_require__) {
	...
	var _angularUiRouter = __webpack_require__(/*! angular-ui-router */ 1);
	
	var _angularUiRouter2 = _interopRequireDefault(_angularUiRouter);
	
	__webpack_require__(/*! ./all.scss */ 2);
	...
	var _homeCtrl = __webpack_require__(/*! ./views/home/homeCtrl.js */ 26);
	
	var _homeCtrl2 = _interopRequireDefault(_homeCtrl);
	
	var _talentCtrl = __webpack_require__(/*! ./views/talent/talentCtrl.js */ 27);
	...
	]).config(_config2.default).controller('HomeController', _homeCtrl2.default).controller('TalentController', _talentCtrl2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../~/css-loader!./../~/autoprefixer-loader!./../~/sass-loader!./all.scss */ 3);
...
/* 3 */
/*!*****************************************************************************!*\
  !*** ./~/css-loader!./~/autoprefixer-loader!./~/sass-loader!./src/all.scss ***!
  \*****************************************************************************/
/***/ function(module, exports, __webpack_require__) {

	exports = module.exports = __webpack_require__(/*! ./../~/css-loader/lib/css-base.js */ 4)();
	// imports
	exports.push([module.id, "@import url(https://fonts.googleapis.com/css?family=Archivo+Narrow:400,700);", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _homeTmpl = __webpack_require__(/*! ./views/home/home-tmpl.html */ 7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _talentService = __webpack_require__(/*! ./talentService/talentService.js */ 14);
	
	var _talentService2 = _interopRequireDefault(_talentService);
	
	var _navService = __webpack_require__(/*! ./navService/navService.js */ 15);
	...
	// import angular from 'angular';
	exports.default = angular.module('PulpServices', []).config(config).service('talentService', _talentService2.default).service('navService', _navService2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jquery = __webpack_require__(/*! jquery */ 16);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sidenav = __webpack_require__(/*! ./sidenav/sidenav.js */ 18);
	
	var _sidenav2 = _interopRequireDefault(_sidenav);
	
	var _headernav = __webpack_require__(/*! ./headernav/headernav.js */ 23);
	...
	// import angular from 'angular';
	exports.default = angular.module('PulpComponents', []).config(config).component('sideNav', _sidenav2.default).component('headerNav', _headernav2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sidenavTmpl = __webpack_require__(/*! ./sidenav-tmpl.html */ 19);
	
	var _sidenavTmpl2 = _interopRequireDefault(_sidenavTmpl);
	
	var _sidenavCtrl = __webpack_require__(/*! ./sidenav-ctrl.js */ 20);
	
	var _sidenavCtrl2 = _interopRequireDefault(_sidenavCtrl);
	
	__webpack_require__(/*! ./assets/icons/Facebook_Solid.svg */ 21);
	
	__webpack_require__(/*! ./assets/icons/Instagram_Solid.svg */ 22);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	// ICONS
	var sideNavOptions = {
		template: _sidenavTmpl2.default,
		controller: _sidenavCtrl2.default,
		controllerAs: 'snCtrl'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headernavTmpl = __webpack_require__(/*! ./headernav-tmpl.html */ 24);
	
	var _headernavTmpl2 = _interopRequireDefault(_headernavTmpl);
	
	var _headernavCtrl = __webpack_require__(/*! ./headernav-ctrl.js */ 25);
	
	var _headernavCtrl2 = _interopRequireDefault(_headernavCtrl);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var headerNavOptions = {
		template: _headernavTmpl2.default,
		controller: _headernavCtrl2.default,
		controllerAs: 'hnCtrl'
	};
...
/***/ function(module, exports) {
	...
	HomeController.$inject = ['$q', '$http'];
	
	function HomeController($q, $http) {
...
/***/ function(module, exports) {
	...
	TalentController.$inject = ['$stateParams'];
	...
	function TalentController($stateParams) {
		...
		vm.talent = {
			...
			photos: [{
				...
				src: 'http://assets.lookbookspro.com/bryant-artists/gm_57b37515-c408-4da5-9797-3e5f0a771fd0.jpg',
				desc: 'Esquire Magazine'
			}, {
				src: 'http://assets.lookbookspro.com/bryant-artists/gm_578528ba-2844-4709-8c03-03c00a771fd0.jpg',
				desc: 'Rolling Stones Magazine'
			}, {
				src: 'http://assets.lookbookspro.com/bryant-artists/gm_57b3752f-bcd8-4c6d-be8a-53580a771fd0.jpg',
				desc: 'People Magazine'
			}, {
				src: 'http://assets.lookbookspro.com/bryant-artists/gm_570b854a-9d1c-46b9-9e65-67cc0a771fd0.jpg',
				desc: 'People Magazine'
			}, {
...
/***/ }
/******/ ]);
//# sourceMappingURL=pulp.bundle.js.map